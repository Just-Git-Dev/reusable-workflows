...
Earlier entries from [`DECISIONS.md`](DECISIONS.md), split out by age on 2026-07-27 to keep the
active log readable. **Nothing here is deprecated** — this is the same decision log, just older.
The full index of both files lives at the top of `DECISIONS.md`. Covers 2026-07-01 → 2026-07-14
(repo creation through the v1.4.0 capability-parity work).
