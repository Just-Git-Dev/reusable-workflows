...
jobs:
  migrate:
    uses: Just-Git-Dev/reusable-workflows/.github/workflows/run-db-job.yml@v2.5.0
    # ...
  api:
    needs: migrate
    uses: Just-Git-Dev/reusable-workflows/.github/workflows/deploy-cloud-run.yml@v2.5.0
    # ...
```
