...
jobs:
  migrate:
    uses: Just-Git-Dev/reusable-workflows/.github/workflows/run-db-job.yml@v1.20.0
    # ...
  api:
    needs: migrate
    uses: Just-Git-Dev/reusable-workflows/.github/workflows/deploy-cloud-run.yml@v1.20.0
    # ...
```
