...
jobs:
  ...
  ci:
    ...
    permissions:
      contents: write
    uses: Just-Git-Dev/reusable-workflows/.github/workflows/ci-node.yml@v2.3.0
    with:
      node_version: '24'
  ...
  stage:
    ...
    uses: Just-Git-Dev/reusable-workflows/.github/workflows/deploy-cloudflare-pages.yml@v2.3.0
    with:
