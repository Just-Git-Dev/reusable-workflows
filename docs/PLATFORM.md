...
jobs:
  ci:
    uses: <org>/reusable-workflows/.github/workflows/ci-go.yml@v1.20.0
...
jobs:
  stage:
    ...
    uses: <org>/reusable-workflows/.github/workflows/deploy-cloud-run.yml@v1.20.0
    with:
  ...
  prod:
    ...
    uses: <org>/reusable-workflows/.github/workflows/promote-image.yml@v1.20.0
    with:
